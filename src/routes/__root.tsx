  ...
  head: () => ({
    meta: [
      ...
      { title: "Education Curatives — Curate Your Global Education Journey" },
      {
        name: "description",
        content:
          "Education Curatives — modern study abroad consultancy curating bespoke pathways to Australia, UK, Germany, Ireland and New Zealand. Visa, IELTS and admissions experts.",
      },
...
function RootShell({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      ...
      <body>
        {children}
        <script src="https://cdn.zanderio.ai/widget/loader.js" data-id="wdg_p8qarvPypj2fn9lFxS8WSC1u" defer></script>
        <Scripts />
      </body>
    </html>
  );
