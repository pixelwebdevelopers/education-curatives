...
import office from "@/assets/ec-building.jpg";
...
export function PageHero({
  ...
  return (
    <section className="relative h-[58vh] min-h-[460px] overflow-hidden bg-navy">
      <motion.img
        initial={{ scale: 1.18 }}
        animate={{ scale: 1 }}
      ...
      <div className="absolute bottom-10 left-10 w-72 h-72 rounded-full bg-[var(--color-accent-gold)]/15 blur-3xl" />

      <div className="relative z-10 mx-auto max-w-7xl h-full px-6 flex flex-col justify-end pb-16">
        <motion.div
